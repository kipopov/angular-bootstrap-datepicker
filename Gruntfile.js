...
(function() {
  module.exports = function(grunt) {
    grunt.initConfig({
      ...
      concat: {
        js: {
          src: ['bower_components/bootstrap-datepicker/js/bootstrap-datepicker.js', 'bower_components/bootstrap-datepicker/js/locales/*.js', 'js/src.js'],
    ...
    return grunt.loadNpmTasks('grunt-contrib-cssmin');
  };
